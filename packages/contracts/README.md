...
- Ten domain records (`remote`, `projects`, `files`, `search`, `git`, `review`, `board`, `actions`,
...
- `procedureCatalog` composes those records into one flat frozen catalog of exactly **113**
