...
/** The ten domain records that currently compose the 111-name live catalog. */
...
const PROCEDURE_COUNT = 111

describe('procedure catalog', () => {
  it('is frozen and composes exactly 111 unique names in domain order', () => {
