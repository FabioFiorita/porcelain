...
| `PDT-006` | Landed | Corruption/atomicity/ownership proof and completed domain gate |
...
| `AGT-001` | Ready | Relocate every Ship responsibility and Audit invariant to current owners |
