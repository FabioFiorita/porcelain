...
/** Write the evidence pack an agent would leave behind: image, video, and an external link. */
export async function seedFixtureEvidence(repoDir: string): Promise<void> {
