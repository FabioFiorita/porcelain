...
internal class TerminalCanvasView(context: Context) : View(context) {
  ...
  private inner class TerminalGestureListener : GestureDetector.SimpleOnGestureListener() {
    ...
    override fun onSingleTapUp(event: MotionEvent): Boolean {
      ...
      // performClick gives the accessible canvas focus after onDown focused the hidden editor.
      // Restore the real input connection or Android shows a keyboard whose keystrokes vanish.
      onRequestKeyboard?.invoke()
      return true
    }
