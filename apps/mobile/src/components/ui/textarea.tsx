...
function Textarea({
  ...
  return (
    <TextInput
      className={cn(
        // `dark:bg-white/5` stands in for the registry's `dark:bg-input/30` — see `input.tsx`.
        'text-foreground border-input dark:bg-white/5 flex min-h-16 w-full flex-row rounded-md border bg-transparent px-3 py-2 text-base shadow-sm shadow-black/5 md:text-sm',
        Platform.select({
