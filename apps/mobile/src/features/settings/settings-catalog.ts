 ...
 */
export type SettingsSection = 'general' | 'companion' | 'remotes' | 'updates'
...
export const SETTINGS_SECTIONS: readonly SettingsSectionDef[] = [
  ...
  },
  {
    ...
    title: 'Companion',
    scope: 'app',
    blurb: 'What git carries for the agents on this machine.',
  ...
  },
  {
    ...
    title: 'Remotes',
    scope: 'environment',
    blurb: 'Pair this device with a daemon. Prefer LAN first; add Tailscale or Funnel as fallbacks.',
...
export function settingsSectionById(id: SettingsSection): SettingsSectionDef {
  ...
  if (found === undefined) return SETTINGS_SECTIONS[0]!
  return found
}
