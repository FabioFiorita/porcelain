...
import { useProjectFolder } from '../../query/project-locations';
...
export function ProjectFolderPicker({
  ...
  return (
    <Collapsible
      ...
      className="group/folders rounded-2xl border"
    >
      <CollapsibleTrigger
        render={
      ...
      <CollapsibleContent>
        <div className="flex flex-col gap-2 p-2 pt-1">
          {current && (
            <Breadcrumb aria-label="Folder path" className="px-1">
              <BreadcrumbList>
          ...
          <ScrollArea className="h-40 rounded-xl border" aria-label="Folders">
