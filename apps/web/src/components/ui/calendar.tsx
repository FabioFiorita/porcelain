...
function CalendarDayButton({
  ...
  return (
    <Button
      ...
      className={cn(
        'relative isolate z-10 flex aspect-square size-auto w-full min-w-(--cell-size) flex-col     group-data-[focused=true]/day:relative group-data-[focused=true]/day:z-10                   ',
        defaultClassNames.day,
        className,
      )}
      {...props}
