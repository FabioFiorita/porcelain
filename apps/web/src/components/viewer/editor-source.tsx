...
import { CommentMarker, commentRowClass } from '@renderer/components/git/comment-marker'
...
// ROW_HEIGHT tall (leading-5), so line N's top is PADDING_TOP + (N-1)*ROW_HEIGHT.
const PADDING_TOP = 8
