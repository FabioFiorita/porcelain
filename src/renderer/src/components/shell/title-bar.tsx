    ...
    <div className="app-drag flex h-12 shrink-0 items-center px-3">
      ...
      <div className="flex flex-1 justify-center">
        <button
          ...
          className="app-no-drag flex h-8 w-full max-w-[440px] items-center gap-2 rounded-lg border border-border/60 bg-black/20 px-3 text-xs text-muted-foreground transition-colors hover:border-ring/40 hover:text-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring/50"
        >
            ...
            <TooltipTrigger
              render={
                <button
                  ...
                  className="glaze-chip flex max-w-48 items-center gap-1.5 rounded-md px-2 py-1 text-xs font-medium text-foreground/90 transition-colors hover:text-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring/50"
                >
