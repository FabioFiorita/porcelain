...
const toggleVariants = cva(
  // rounded-md (not the shadcn rounded-3xl pill) so toggle chips share the tab's
  // tile-family radius — one chip language across tabs, segmented controls, and
  // commit chips. See main.css Glaze segment grammar.
