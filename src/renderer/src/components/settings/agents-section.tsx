  ...
  return (
    <div className="flex min-w-0 flex-col gap-8">
      ...
      <section className="flex min-w-0 flex-col gap-3">
        <SectionHeading
          title="Skills"
          blurb="Companion skills teach your agent how to push feature reviews (Intent, Execution, Evidence), read comments, manage the board, and curate actions. They ship through skills.sh and update independently of the bundled CLI."
        />
        <SkillsSection />
      </section>
      ...
      <section className="flex min-w-0 flex-col gap-3">
        <SectionHeading
          title="CLI"
          blurb="Agents drive Porcelain's channels — feature reviews, comments, the board, actions, evidence — by running the bundled CLI. Nothing to configure."
        />
        <p className="text-xs text-muted-foreground">
