...
| Environment switcher | `environment-switcher.tsx` | Native-shell control for moving between Environments. The browser keeps the serving Environment plus configured remote sessions and identifies each Project with its Environment badge |
