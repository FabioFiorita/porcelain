...
The deletion is one SQLite transaction covering the project's published reviews, layer and file marks, comments, preferences, Git preparations and receipts, inventory, and retained ownership records. Other projects and the environment identity survive. SQLite file shrinkage and secure physical erasure are not promised.
