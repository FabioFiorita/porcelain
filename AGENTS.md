...
present, read the root `AGENTS.local.md` for host routing; mobile simulator/build/proof details are
scoped to `apps/mobile/AGENTS.local.md` and should not burden desktop or daemon-only sessions.
